(() => {
  if (window.__figureLoomStableRuntime71d36dfV65) return;
  ...
  const STABLE_BUILD = "stable-71d36df-locked-20260720-v65";
  const GENERAL_ADDONS = [
    ...
    "pptx-converter-loader.js",
    "pptx-verified-writer.js",
