(() => {
  if (window.__figureLoomStableRuntime71d36dfV19) return;
  window.__figureLoomStableRuntime71d36dfV19 = true;

  const STABLE_BUILD = "stable-71d36df-locked-20260718-v19";
