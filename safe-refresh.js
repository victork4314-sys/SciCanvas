(() => {
  if (window.__figureLoomStableRuntime71d36dfV18) return;
  window.__figureLoomStableRuntime71d36dfV18 = true;

  const STABLE_BUILD = "stable-71d36df-locked-20260718-v18";
