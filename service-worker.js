const FIGURELOOM_BUILD_ID = "stable-71d36df-locked-20260720-v69";
...
self.addEventListener("install", event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request("./safe-refresh.js?v=stable-71d36df-locked-20260720-v69", { cache:"reload" })),
      cache.add(new Request("./mcp-command-registry.js?v=stable-71d36df-locked-20260720-v69", { cache:"reload" })),
      ...
      cache.add(new Request("./mcp-office-command-adapter.js?v=stable-71d36df-locked-20260720-v69", { cache:"reload" })),
