...
self.addEventListener("install", event => {
  event.waitUntil((async () => {
    ...
    await Promise.allSettled([
      ...
      cache.add(new Request("./input-platform-polish.js", { cache:"reload" })),
      cache.add(new Request("./input-platform-polish.js?v=1", { cache:"reload" })),
      ...
      cache.add(new Request("./figureloom-mark.svg?v=2", { cache:"reload" })),
      cache.add(new Request("./figureloom-pinned-tab-v1.svg", { cache:"reload" })),
      cache.add(new Request("./browserconfig-v1.xml", { cache:"reload" })),
      cache.add(new Request("./favicon.ico?v=20260719-v1", { cache:"reload" })),
      cache.add(new Request("./figureloom-icon-32-v1.png?v=20260719-v1", { cache:"reload" })),
      cache.add(new Request("./figureloom-apple-touch-180-v1.png?v=20260719-v1", { cache:"reload" })),
      cache.add(new Request("./figureloom-app-192-v1.png?v=20260719-v1", { cache:"reload" })),
      cache.add(new Request("./figureloom-app-512-v1.png?v=20260719-v1", { cache:"reload" })),
      cache.add(new Request("./mstile-150x150-v1.png?v=20260719-v1", { cache:"reload" })),
      cache.add(new Request("./mstile-310x310-v1.png?v=20260719-v1", { cache:"reload" })),
