...
FigureLoom is a browser-based editor for scientific figures, diagrams, posters, presentations, charts, pathways, maps, and other visual research work.
...
- The FigureLoom Bio IDE supports normal text and editable sentence blocks that produce the same downloadable `.flbio` program.
...
- [Canvas, pages, and layers](Canvas-Pages-and-Layers)
- [Text, shapes, arrows, and connectors](Text-Shapes-Arrows-and-Connectors)
- [Images, SVG, and uploads](Images-SVG-and-Uploads)
...
- [Review, references, and accessibility](Review-References-and-Accessibility)
...
- [Loomy](Loomy)
- [Keyboard shortcuts and touch gestures](Keyboard-Shortcuts-and-Touch-Gestures)
